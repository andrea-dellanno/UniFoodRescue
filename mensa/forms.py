...
class LottoForm(BootstrapModelForm):
    class Meta:
        ...
        help_texts = {
            ...
            'data_scadenza': 'Data in cui gli studenti possono ritirare il lotto.',
...
class PrenotazioneForm(forms.Form):
    quantita = forms.IntegerField(
        ...
        help_text='Puoi prenotare al massimo 99 porzioni per volta.',
    )
    ...
    def __init__(self, *args, lotto=None, **kwargs):
        ...
        self.fields['quantita'].help_text = (
            f'Puoi prenotare al massimo {massimo_prenotabile} porzioni.'
        )
