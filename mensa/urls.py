...
urlpatterns = [
    ...
    # Pagina pubblica: tutte le recensioni ricevute dalle mense
    path('recensioni/', views.recensioni_mense, name='recensioni_mense'),
    ...
    # Area studente: solo recensioni scritte dallo studente loggato
    path('studente/recensioni/', views.mie_recensioni, name='mie_recensioni'),
    path('studente/recensioni/<int:pk>/', views.dettaglio_mia_recensione, name='dettaglio_mia_recensione'),
    ...
    path('amministrazione/mense/<int:pk>/elimina/', views.MensaDelete.as_view(), name='admin_mensa_delete'),
    ...
    path('amministrazione/categorie/<int:pk>/elimina/', views.CategoriaDelete.as_view(), name='admin_categoria_delete'),
    ...
    path('amministrazione/allergeni/<int:pk>/elimina/', views.AllergeneDelete.as_view(), name='admin_allergene_delete'),
    ...
    path('amministrazione/prodotti/<int:pk>/elimina/', views.ProdottoDelete.as_view(), name='admin_prodotto_delete'),
